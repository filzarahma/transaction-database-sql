...
WHERE orders.orderDate LIKE '2005-__-__';

SELECT COUNT(SUM(amount)*90/100) AS totalPembayaran , paymentDate
FROM payments
GROUP BY Year(paymentDate)
HAVING paymentDate BETWEEN '2005-05-01' AND '2005-05-31';

SELECT paymentDate
FROM payments
WHERE paymentDate BETWEEN '2005-05-01' AND '2005-05-31';

SELECT products.productLine, orderdetails.quantityOrdered * orderdetails.priceEach AS Harga, orders.status, orders.orderDate
FROM orderdetails, products, orders
WHERE orders.status = "Shipped" AND orders.orderDate = '2003-11-11';
